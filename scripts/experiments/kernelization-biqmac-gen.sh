...
declare -a arr=("128" "256")

rm ../data/graphs-biqmac/*

for i in "${arr[@]}"
do
    ./$selected_build -action "kernelization" -iterations 1 -sample-kagen 20 -num-nodes $i -num-edges-lo 0 -num-edges-hi $((i*8)) -total-allowed-solver-time -1 \
    ...
    ./$selected_build -action "kernelization" -iterations 1 -sample-kagen 20 -num-nodes $i -num-edges-lo 0 -num-edges-hi $((i*8)) -total-allowed-solver-time -1 -support-weighted-result \
