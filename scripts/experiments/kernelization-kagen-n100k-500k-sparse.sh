...
for i in "${arr[@]}"
do
    ./$selected_build -action "kernelization" -iterations 1 -sample-kagen 50 -num-nodes $i -num-edges-lo 0 -num-edges-hi $((i*8)) -total-allowed-solver-time -1 \
    ...
    ./$selected_build -action "kernelization" -iterations 1 -sample-kagen 50 -num-nodes $i -num-edges-lo 0 -num-edges-hi $((i*8))  -total-allowed-solver-time -1 -support-weighted-result \
