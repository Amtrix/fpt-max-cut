...
func_localize() {
    ...
    mkdir -p $experiment_outdir/solvers/real-world-small-w/
    $builddir/./$selected_build -action "kernelization" -iterations 1 -fdir $thesis_tests/real-world-small  \
                    ...
                    -benchmark-output $experiment_outdir/solvers/real-world-small-w/out > $experiment_outdir/solvers/real-world-small-w/out-exe
