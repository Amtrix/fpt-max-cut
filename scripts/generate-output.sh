...
./benchmark -action "kernelization" -sample-kagen 20 -benchmark-output ../data/output/kernelization/out20 > ../data/output/kernelization/out20-exe -num-edges-lo 8000 -num-edges-hi 24000 -num-nodes 8000
cd ../data/output/kernelization
Rscript plotting-compare.r --file out20 --out plot-cmp-out20.pdf
cd ../../../build

./benchmark -action "kernelization" -sample-kagen 50 -benchmark-output ../data/output/kernelization/out50 > ../data/output/kernelization/out50-exe -num-edges-lo 8000 -num-edges-hi 30000 -num-nodes 8000
cd ../data/output/kernelization
