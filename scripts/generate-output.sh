...
for i in "${arr[@]}"
do
    ./benchmark -action "kernelization" -sample-kagen $i -benchmark-output ../data/output/kernelization/out$i > ../data/output/kernelization/out$i-exe -num-edges-lo 10000 -num-edges-hi 16000 -num-nodes 8000 -locsearch-iterations 200
