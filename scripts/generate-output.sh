...
for i in "${arr[@]}"
do
    ./$bin_exe -action "kernelization" -sample-kagen $i -benchmark-output ../data/output/kernelization/out$i > ../data/output/kernelization/out$i-exe -num-edges-lo 4000 -num-edges-hi 40000 -num-nodes 8000 -locsearch-iterations 200 -mqlib-iterations 5
